...
void MaiaXmlRpcServerConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MaiaXmlRpcServerConnection::getMethod)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MaiaXmlRpcServerConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MaiaXmlRpcServerConnection.data,
      qt_meta_data_MaiaXmlRpcServerConnection,  qt_static_metacall, nullptr, nullptr}
};
